...
export const ko: Dict = {
  ...
  'settings.fontFamily.system': '시스템 고정폭',
  'settings.fontFamily.hint': '글꼴은 앱에 포함되어 있지 않습니다. 이 기기에 설치된 글꼴만 적용되며, 없으면 시스템 고정폭 글꼴을 사용합니다.',
  'settings.editorTheme': '편집기 테마',
  'settings.editorTheme.auto': '인터페이스 따르기',
  'settings.editorTheme.dark': '다크',
  'settings.editorTheme.light': '라이트',
  'settings.wordWrap': '자동 줄 바꿈',
  'settings.minimap': '미니맵',
  'settings.lineNumbers': '줄 번호',
  'settings.fontLigatures': '합자',
  'settings.fontLigatures.hint': '=>, !=, >= 같은 기호 조합을 하나의 글리프로 표시합니다. Fira Code, JetBrains Mono처럼 합자를 지원하는 글꼴에서만 동작합니다.',
  'settings.reset': '기본값 복원',
  'settings.shortcuts': '단축키',
  'settings.shortcuts.app': '앱',
  'settings.shortcuts.editorBuiltin': '편집기 (기본 제공)',
  'settings.shortcuts.rename': '이름 바꾸기 (사이드바에서 선택 시)',
  'settings.shortcuts.palette': '명령 팔레트',
  'settings.shortcuts.find': '찾기',
  'settings.shortcuts.replace': '바꾸기',
  'settings.shortcuts.format': '문서 서식',
  'settings.shortcuts.comment': '줄 주석 전환',
  'settings.shortcuts.moveLine': '줄 위/아래로 이동',
  'settings.shortcuts.copyLine': '줄 아래로 복사',
  'settings.shortcuts.multiCursor': '다음 일치 항목 선택',
  'settings.close': '닫기',
