...
export const pt: Dict = {
  ...
  'settings.fontFamily.system': 'Monoespaçada do sistema',
  'settings.fontFamily.hint': 'As fontes não vêm com o app. Uma fonte só tem efeito se estiver instalada neste dispositivo; caso contrário, usa-se a monoespaçada do sistema.',
  'settings.editorTheme': 'Tema do editor',
  'settings.editorTheme.auto': 'Seguir a interface',
  'settings.editorTheme.dark': 'Escuro',
  'settings.editorTheme.light': 'Claro',
  'settings.wordWrap': 'Quebra de linha',
  'settings.minimap': 'Minimapa',
  'settings.lineNumbers': 'Números de linha',
  'settings.fontLigatures': 'Ligaduras',
  'settings.fontLigatures.hint': 'Exibe combinações como =>, != e >= como um único glifo. Funciona apenas com fontes que suportam ligaduras, como Fira Code ou JetBrains Mono.',
  'settings.reset': 'Redefinir',
  'settings.shortcuts': 'Atalhos',
  'settings.shortcuts.app': 'Aplicativo',
  'settings.shortcuts.editorBuiltin': 'Editor (integrados)',
  'settings.shortcuts.rename': 'Renomear (selecionado na barra lateral)',
  'settings.shortcuts.palette': 'Paleta de comandos',
  'settings.shortcuts.find': 'Localizar',
  'settings.shortcuts.replace': 'Substituir',
  'settings.shortcuts.format': 'Formatar documento',
  'settings.shortcuts.comment': 'Alternar comentário de linha',
  'settings.shortcuts.moveLine': 'Mover linha para cima / baixo',
  'settings.shortcuts.copyLine': 'Copiar linha para baixo',
  'settings.shortcuts.multiCursor': 'Selecionar próxima ocorrência',
