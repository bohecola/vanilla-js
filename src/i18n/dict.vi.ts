...
export const vi: Dict = {
  ...
  'settings.mode': 'Chủ đề',
  'settings.accent': 'Màu nhấn',
  'settings.language': 'Ngôn ngữ',
  'settings.editor': 'Trình soạn thảo',
  'settings.fontSize': 'Cỡ chữ',
  'settings.fontFamily': 'Phông chữ',
  'settings.fontFamily.system': 'Monospace hệ thống',
  'settings.fontFamily.hint': 'Ứng dụng không kèm phông chữ. Phông chỉ có hiệu lực nếu đã cài trên thiết bị này; nếu không sẽ dùng phông monospace của hệ thống.',
  'settings.editorTheme': 'Chủ đề trình soạn thảo',
  'settings.editorTheme.auto': 'Theo giao diện',
  'settings.editorTheme.dark': 'Tối',
  'settings.editorTheme.light': 'Sáng',
  'settings.wordWrap': 'Tự động xuống dòng',
  'settings.minimap': 'Bản đồ thu nhỏ',
  'settings.lineNumbers': 'Số dòng',
  'settings.fontLigatures': 'Chữ ghép',
  'settings.fontLigatures.hint': 'Hiển thị các cặp ký hiệu như =>, != và >= thành một ký tự duy nhất. Chỉ hoạt động với phông hỗ trợ chữ ghép như Fira Code hoặc JetBrains Mono.',
  'settings.reset': 'Đặt lại',
  'settings.shortcuts': 'Phím tắt',
  'settings.shortcuts.app': 'Ứng dụng',
  'settings.shortcuts.editorBuiltin': 'Trình soạn thảo (tích hợp)',
  'settings.shortcuts.rename': 'Đổi tên (khi chọn trong thanh bên)',
  'settings.shortcuts.palette': 'Bảng lệnh',
  'settings.shortcuts.find': 'Tìm',
  'settings.shortcuts.replace': 'Thay thế',
  'settings.shortcuts.format': 'Định dạng tài liệu',
  'settings.shortcuts.comment': 'Bật/tắt chú thích dòng',
  'settings.shortcuts.moveLine': 'Di chuyển dòng lên / xuống',
  'settings.shortcuts.copyLine': 'Sao chép dòng xuống dưới',
  'settings.shortcuts.multiCursor': 'Chọn kết quả trùng tiếp theo',
  'settings.close': 'Đóng',
